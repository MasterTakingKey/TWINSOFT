...
public class ControladorPartida {
    ...
    public void inicializarBarajaTablero() {
    	...
    	barajaPartida.barajaTematica(new CrearBarajaAnimalesEstrategia(2), 16);
    ...
    public void mostrarResultado() {
    	try {
    		...
    		if(isVictoria()) {
            	controladorResultadoPartida.iniciarResultado(primaryStage, SoundOn, puntuacionFinal, tiempoSobrante, true, "estandar", thisStage.getX(), thisStage.getY(), 4, 4);
        	} else {
        		controladorResultadoPartida.iniciarResultado(primaryStage, SoundOn, puntuacionFinal, tiempoSobrante, false, "estandar", thisStage.getX(), thisStage.getY(), 4, 4);
        	}
    		stage.show();
    	} catch (IOException e) {
